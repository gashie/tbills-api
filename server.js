...
app.listen(PORT, () => {
    console.log(
        `OPENSOURCE: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`
    );
    logger.debug(`OPENSOURCE: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`);
});
